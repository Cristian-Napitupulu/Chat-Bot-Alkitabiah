...
model = BertForSequenceClassification.from_pretrained(
    nama_model, num_labels=len(categories), ignore_mismatched_sizes=True
)
...
def get_prediction(str):
    ...
    # Tokenize input text
    inputs = tokenizer(
        example_text, padding=True, truncation=True, return_tensors="pt"
    ).to(device)
...
pertanyaan_list = data__

print(pertanyaan_list)
